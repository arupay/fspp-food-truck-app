...
('10', 'Mary', 'I''ve been a regular customer here . Its delicious. Their fish taco, Mexican sausage taco and carne enchilada (spicy pork) are my favorite. Usually three tacos fills me up. They are actually really big and wrapped in two soft tortillas . It'' very savory and satisfying', 5),
('11', 'Vladimir','We asked Anton''s dumplings to do an event at Big Deal Casino and they were out of this world! In spite of having a work emergency, they showed up and feed our guests delicious dumplings. Thanks guys!', 5 ),
('11', 'Maria', 'These are the PERFECT delivery food. The dumplings are well-cooked, not doughy, and I love the original flavors. The large comes with about 30 bite sized dumplings! Love it!', 4);
